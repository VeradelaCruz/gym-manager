    ...
    public void run(String... args) throws Exception {
        if (repository.count() == 0) {
            List<FitnessClass> classes = List.of(
                    new FitnessClass("Class01", "Yoga Flow", "Laura Gómez", 20,
                            LocalDateTime.of(2025, 11, 6, 9, 30), 60L, 12.5, true),

                    new FitnessClass("Class02", "CrossFit Power", "Carlos Méndez", 15,
                            LocalDateTime.of(2025, 11, 6, 18, 0), 45L, 15.0, true),

                    new FitnessClass("Class03", "Spinning Intenso", "Sofía Ramírez", 25,
                            LocalDateTime.of(2025, 11, 7, 7, 0), 50L, 10.0, true),

                    // ➕ Nuevas clases
                    new FitnessClass("Class04", "Pilates Core", "María López", 18,
                            LocalDateTime.of(2025, 11, 7, 11, 0), 55L, 11.0, true),

                    new FitnessClass("Class05", "HIIT Express", "David Rojas", 12,
                            LocalDateTime.of(2025, 11, 8, 8, 30), 30L, 9.0, true),

                    new FitnessClass("Class06", "Zumba Dance", "Valentina Ruiz", 30,
